...
-- 普通商品（image_url 指向 Nginx 静态路径）
INSERT INTO `product` (`name`, `description`, `price`, `stock`, `image_url`, `status`) VALUES
('iPhone 15 Pro',   'A17 Pro芯片，钛金属机身，4800万像素主摄，支持USB-C传输。专业级摄影系统，拍照录像行业领先。', 7999.00, 1000, '/static/images/product_1.png', 1),
('小米14 Ultra',    '徕卡光学大师镜头，骁龙8 Gen3处理器，5000mAh超大电池，90W有线+80W无线双快充。', 5999.00, 500, '/static/images/product_2.png', 1),
('AirPods Pro 2',  'H2芯片驱动主动降噪，自适应通透模式，个性化空间音频，续航长达6小时。', 1899.00, 2000, '/static/images/product_3.png', 1),
('MacBook Pro 14',  'M3 Pro芯片，Liquid Retina XDR屏幕，18小时超长续航，专业创作者首选。', 14999.00, 300, '/static/images/product_4.png', 1),
('iPad Air 5',      'M1芯片，10.9英寸全面屏，支持Apple Pencil 2代和妙控键盘，轻薄便携。', 4799.00, 800, '/static/images/product_5.png', 1);

-- 秒杀商品
INSERT INTO `seckill_product`
    (`name`, `description`, `origin_price`, `seckill_price`,
     `total_stock`, `avail_stock`, `image_url`,
     `start_time`, `end_time`, `status`) VALUES
('Switch OLED 秒杀版',
 '任天堂Switch OLED版，7英寸OLED屏，白色Joy-Con，64GB存储，原价2799元，秒杀价1999！限量100台，先到先得！',
 2799.00, 1999.00, 100, 100, '/static/images/seckill_1.png',
 DATE_SUB(NOW(), INTERVAL 1 HOUR), DATE_ADD(NOW(), INTERVAL 2 HOUR), 1),

('索尼 WH-1000XM5',
 '头戴式旗舰降噪耳机，行业领先降噪性能，30小时续航，快充10分钟可用5小时。原价2999，秒杀价1599！',
 2999.00, 1599.00, 50, 50, '/static/images/seckill_2.png',
 DATE_SUB(NOW(), INTERVAL 30 MINUTE), DATE_ADD(NOW(), INTERVAL 3 HOUR), 1),

('DJI Mini 4 Pro',
 '4K/60fps超高清拍摄，全向避障，46分钟超长续航，重量不足249g无需登记。原价4799，秒杀价3299！限量30台！',
